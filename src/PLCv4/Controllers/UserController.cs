...
namespace PLCV4.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(UserManager<Utilizador> userManager, RoleManager<ApplicationRole> roleManager)
        {
        ...
        {
            UtilizadorViewModel model = new UtilizadorViewModel();
        ...
        [HttpPost]
        public async Task<IActionResult> AddUser(UtilizadorViewModel model)
        {
        ...
        public async Task<IActionResult> DeleteUser(string id)
        {
            ...
            if (!String.IsNullOrEmpty(id))
            {
                Utilizador applicationUser = await userManager.FindByIdAsync(id);
